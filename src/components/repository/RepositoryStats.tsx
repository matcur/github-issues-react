...
import {RepositoryStats as RepositoryStatsModel} from "../../models";
import {castToThousands} from "../../utils/castToThousands";

type Props = {
  stats: RepositoryStatsModel
}

const RepositoryStats = ({stats}: Props) => {
  return (
    <div className="repository-stats-list">
      <div className="repository-stats">
        ...
        <div className="count">{castToThousands(stats.watched)}</div>
      </div>
      <div className="repository-stats">
        <div className="stats-name-wrapper hover-element hover-element-border lr-4">
          <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" height="16"
        ...
        <div className="count">{castToThousands(stats.stars)}</div>
      </div>
      <div className="repository-stats">
        <div className="stats-name-wrapper hover-element hover-element-border lr-4">
          <svg aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" height="16"
        ...
        <div className="count">{castToThousands(stats.forks)}</div>
      </div>
    </div>
  )
}
